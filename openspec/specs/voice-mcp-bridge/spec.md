...
Governs how Voice manages MCP server child processes: lifecycle, pipe discipline, failure
handling, tool schema translation, gating, batch execution, result mapping, size limits,
per-call timeouts, and server-death handling.
