# voice-spawn-protocol

## Purpose

Governs how Voice is invoked by Harmony: the five spawn environment variables, the stdout
progress-stream discipline, the exit-code contract, and SIGTERM cancellation.
